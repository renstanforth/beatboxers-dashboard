    ...
    <div class="ts narrow container relaxed stackable grid">
      <div class="eleven wide column" style="padding: 0px">
        <div class="column" style="">
          ...
          <p>
            We are committed to safeguarding your privacy. Contact us at if you
            have any questions or problems regarding the use of your Personal
            Data and we will gladly assist you.
          </p>
          <p>
          ...
          <h2 id="Definitions">
            <a href="#Definitions" class="headerlink" title="Definitions"></a
            >Definitions
          </h2>
          <ul>
            <li>
            ...
            <li>
              <strong>Data subject</strong> – a natural person whose Personal
              Data is being Processed.
            </li>
            <li>
              <strong>Child</strong> – a natural person under 16 years of age.
            </li>
            <li><strong>We/us</strong> (either capitalized or not) –</li>
          </ul>
          <h2 id="Data-Protection-Principles">
            <a
              href="#Data-Protection-Principles"
              class="headerlink"
          ...
          <h2 id="Data-Subject’s-rights">
            <a
              href="#Data-Subject’s-rights"
              class="headerlink"
          ...
          <ul>
            <li>
              <p>
                Information you have provided us with.<br />This might be your
                e-mail address, name, comment etc – mainly information that is
                necessary for delivering you a product/service or to enhance
                your customer experience with us. We save the information you
                provide us with in order for you to comment or perform other
                activities on the website. This information includes, for
                example, your name and e-mail address.
              </p>
            </li>
            <li>
              <p>
                Information automatically collected about you.<br />This
                includes information that is automatically stored by cookies and
                other session tools. For example, your IP address. This
            ...
            <li>
              <p>
                Information from our partners.<br />We gather information from
                our trusted partners with confirmation that they have legal
                grounds to share that information with us. This is either
                information you have provided them directly with or that they
                have gathered about you on other legal grounds. See the list of
                our partners here.
              </p>
            </li>
            <li>
              <p>
                Publicly available information.<br />We might gather information
                about you that is publicly available.
              </p>
            </li>
          </ul>
          <h2 id="How-we-use-your-Personal-Data">
            <a
              href="#How-we-use-your-Personal-Data"
              class="headerlink"
          ...
          <ul>
            <li>
              to send you campaign offers (from us and/or our carefully selected
              partners);
            </li>
          ...
          <p>
            ...
            from law and/or use your Personal Data for options provided by law.
            We reserve the right to anonymise Personal Data gathered and to use
            any such data. We will use data outside the scope of this Policy
            only when it is anonymised. We save your information gathered about
            you for as long as needed for accounting purposes or other
            obligations deriving from law, but not longer than required.
          </p>
          <p>
          ...
          <p>
            We will inform you of any further Processing and purposes.<br />Who
            else can access your Personal Data
          </p>
          <p>
            ...
            your customer experience. We share your data with:
          </p>
          <p>Our processing partners:</p>
          <ul>
          ...
          <ul>
            <li>Pluralsight, Inc</li>
            <li>Amazon, Inc</li>
          </ul>
          <p>Connected third parties:</p>
          <ul>
            <li>Google, Inc</li>
            <li>Twitter, Inc</li>
            <li>Facebook, Inc</li>
          ...
          <p>
            ...
            adequate level of protection to your Personal Data. We disclose your
            Personal Data to third parties or public officials when we are
            legally obliged to do so. We might disclose your Personal Data to
            third parties if you have consented to it or if there are other
            legal grounds for it.
          </p>
          <h2 id="How-we-secure-your-data">
            <a
              href="#How-we-secure-your-data"
              class="headerlink"
          ...
          <p>
            ...
            We use anonymising and pseudonymising where suitable. We monitor our
          ...
          <h2 id="Children">
            <a href="#Children" class="headerlink" title="Children"></a>Children
          </h2>
          <p>
            We do not intend to collect or knowingly collect information from
            children. We do not target children with our services.
          </p>
          <h2 id="Cookies-and-other-technologies-we-use">
            <a
              href="#Cookies-and-other-technologies-we-use"
              class="headerlink"
              title="Cookies and other technologies we use"
            ></a
          ...
          <p>
            ...
            the browser level. Choosing to disable cookies may hinder your use
          ...
          <ul>
            ...
            <li>
              ...
              personalised features possible. For example, they might remember
          ...
          <p>
            ...
            <a
              ...
              rel="external nofollow"
              target="_blank"
              >Google Analytics opt-out page</a
            >.
          </p>
          <h2 id="Limited-Gathering-of-Information-for-Statistical-Purposes">
            <a
              href="#Limited-Gathering-of-Information-for-Statistical-Purposes"
              class="headerlink"
              title="Limited Gathering of Information for Statistical Purposes"
            ></a
            >Limited Gathering of Information for Statistical Purposes
          </h2>
          <p>
            We automatically collects certain information using third-party
            analytics and / or log programs to help us understand how our users
            use the Website, but none of this information identifies you
            personally. For example, each time you visit the site we
            automatically collect your IP address, browser and computer type,
            access times, the web page from which you came, and the web page(s)
            you access. We use this information only to better understand your
            needs and the needs of Website users in the aggregate, and to be
            able to trace fraudulent activities if necessary. We also makes use
            of information gathered for statistical purposes to keep track of
            the number of visits to the Website and which pages on the Website
            with a view to introducing improvements.
          </p>
          <h2 id="Tracking-Technology-“Cookies”">
            <a
              href="#Tracking-Technology-“Cookies”"
              class="headerlink"
              title="Tracking Technology (“Cookies”)"
            ></a
            ><strong>Tracking Technology (“Cookies”)</strong>
          </h2>
          <p>
            We may use tracking technology (“cookies”) on the Website and by
            using the Website you agree to their use. Cookies are small text
            files placed on your hard drive when you visit a web site, in order
            to track use of the site and to improve the user experience by
            storing certain data on your computer. The Website may use “session
            cookies,” which improve your browsing experience by storing certain
            information from your current visit on your computer.
          </p>
          <p>
            Your browser can be set to refuse cookies or delete them after they
            have been stored. Please note that deleting these cookies may reduce
            your user experience on the site by requiring you to re-enter
            certain information, such as information required to use the
            Services.
          </p>
          <h2 id="Risks-Associated-with-the-Internet">
            <a
              ...
              class="headerlink"
              title="Risks Associated with the Internet"
            ></a
            ><strong>Risks Associated with the Internet</strong>
          </h2>
          <p>
            Despite our efforts to ensure third parties will not access or
            obtain your personal information through the Website, complete
            confidentiality and security cannot currently be guaranteed on the
            Internet. Communication via the Internet is subject to interception,
            loss, or alteration. You acknowledge and agree that we cannot be
            held responsible for damages resulting from the transmission of
            confidential information or personal information over the Internet
            and that such communications are at your own risk.
          </p>
          ...
          <p>
            We will not be held liable for any damages resulting from the misuse
            of any information collected through the Website by any third party,
            or any misuse of any information collected through the Website not
      ...
      <div class="four wide column" style="padding-top: 35px"></div>
    </div>
  </div>
</template>
